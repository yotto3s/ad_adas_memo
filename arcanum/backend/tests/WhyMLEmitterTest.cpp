...
// Trap-mode bounds tests (parameterized) ---
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        WrapModeParam{
            "U8WrapMod256", 8, false, "add_u8", {"256", "mod"}, {"assert"}},
        WrapModeParam{"SignedI8WrapMod256", 8, true, "add_i8_wrap",
                      {"256", "mod", "128"}, {}},
...
// CastOp with wrap mode imports ComputerDivision even without
